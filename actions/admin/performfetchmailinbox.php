...
$conn = $data->getConnection();
    ...
    $client_sqlclient = "select client_contact_email from client_contacts";
                                ...
                                foreach($emails as $email_number) {
                                    ...
                                    foreach ($to as $id => $object) {
                                        ...
                                        if (in_array($toaddress, $clientemails)) {
                                            ?>
                                            <tr>
                                                <td width="15%" > <?php echo $overview[0]->date;?> </td>
                                                <td width="15%"> <?php echo $overview[0]->from;?> <br> <?php echo $toaddress;?> </td>
                                            <?php
                                            ...
                                            ?>
                                            <td width="55%" id="msg"><b> <?php echo $overview[0]->subject;?> </b><br> <?php echo $plainmsg;?> </td>
                                            <?php
                                            ...
                                            foreach($attachments as $attachment)
                                            {
                                                ...
                                                if($attachment['is_attachment'] == true)
                                                {
                                                    ...
                                                    ?>
                                                    <?php 
                                                    $php_self = explode("/", $_SERVER['PHP_SELF'])[1];
                                                    echo "<a href='/$php_self/actions/admin/".$email_number."-".$filename."' download='$filename'> $filename</a><br>";?>  
