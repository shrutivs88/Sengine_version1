    ...
    <div class="content-view">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <h2 class="text-center">Configurations / Mail Configuration / Mail Template</h2>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <a class="config-item-wrapper-link" href="addmailtemplate.php">
                        ...
                        <div class="col-sm-3">
                            <a class="config-item-wrapper-link" href="mailtemplatelist.php">
                                <div class="config-item">
                                    <div class="config-item-thumbnail">
