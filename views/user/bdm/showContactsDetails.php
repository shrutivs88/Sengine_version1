...
<head>
    ...
    //Client List ajax starts
        ...
        function client_fetch_List(){
            ...
            $.ajax({
                url: '<?php echo BASEURL;?>actions/bdm/performfetchclientlistforcompany.php',
                type: 'POST',
                data: {
                ...
                if(response.length == 0 && isUpdateOffsetPristine == true)
                    {
                        $("#bdm-container").html("<h4 class='text-center'>No More Client Contacts Are Available!</h4>");
                        $("#ajaxButton").hide();
                        return;
    ...
    <div class="content-view">
        <div class="container-fluid">
            ...
            <?php if ($_SESSION['role'] == "BDM") : ?>
             ...
             <a href="companylist.php"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-chevron-left"></span>Go Back</button></a>
             <h3 class="text-center">  Client Contact List of <b id="company"></b> Company  </h3>
